package com.rapidcassandra.Chapter03;
...
import com.rapidcassandra.Chapter03.repository.CassandraTraderDAO;
import com.rapidcassandra.Chapter03.repository.TradingSignal;
import com.rapidcassandra.Chapter03.util.CassandraTraderUtil;
import com.rapidcassandra.Chapter03.util.YahooFetcher;
...
public class CassandraTrader {
	...
	public void getData(final String symbol, final CassandraTraderDAO qp) {
		...
		final BufferedReader br = YahooFetcher.getStock(symbol);
		// final Boolean br = YahooFetcher.getStock(symbol);
		...
		try {
			...
			for (String line = br.readLine(); line != null; line = br
				...
				if (!Pattern.matches("timestamp", feed[0])) {
	...
	public static void main(String[] args) {
		...
		final CassandraTraderDAO qp = new CassandraTraderDAO("10.0.1.103", 9042);
		...
		Date fromDate = CassandraTraderUtil.convertDate("2018-01-01");
		Date toDate = CassandraTraderUtil.convertDate("2018-03-10");
